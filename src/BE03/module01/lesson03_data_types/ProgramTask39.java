...
public class ProgramTask39 {
    public static void main(String[] args) {
        ...
        String string = "Текст"; // Создается сразу в стрит пуле
        String string1 = new String("Текст"); // Создается в HEAP  сразу в хипе (а также создалось бы в пуле, если бы такого слова не было еще, но оно есть, поэтому только в хипе)
