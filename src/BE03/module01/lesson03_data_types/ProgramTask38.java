...
public class ProgramTask38 {
    public static void main(String... args) {
        ...
        // 3/2 = 1 (1)
        // 1/2 = 0 (1)
        int num123Binary = 0b1111011;// число 15 в двоичной системе счисления
        System.out.println(num123Binary);

        // 123/8 = 15 (3)
        // 15/8 = 1 (7)
        // 1/8 = 0 (1)
        int num123Octal = 0173;// число 15 в восьмеричной
        System.out.println(num123Octal);

        // 123/16 = 7(11)
        // 7/16 = 0(7)
        int num123Hexadecimal = 0x7B;// число 111 в шестнадцатеричной
